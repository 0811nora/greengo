            ...
            <div className="mx-auto d-flex justify-content-between align-items-center py-5 ">
                <div className="text-center ">
                    <p className={`fs-3  ${ stepState >= 1 ? "text-primary" : " "}`}>
                        {stepState > 1 ? <i className="bi bi-check-circle-fill"></i> : <i className="bi bi-1-circle-fill"></i>}
                    </p>
                ...
                <div className="text-center ">
                    <p className={`fs-3 ${ stepState >= 2 ? "text-primary" : " "}`}>
                        {stepState > 2 ? <i className="bi bi-check-circle-fill"></i> : <i className="bi bi-2-circle-fill"></i>}
                    </p>
                ...
                <div className="text-center ">
                    <p className={`fs-3 ${ stepState >= 3 ? "text-primary" : " "}`}>
                        {stepState > 3 ? <i className="bi bi-check-circle-fill"></i> : <i className="bi bi-3-circle-fill"></i>}
                    </p>
