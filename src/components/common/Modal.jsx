	...
	return (
		...
		>
			...
			<Modal.Footer className="d-flex align-items-center gap-2 modal__footer">
				<button className={`modal__button ${style}__modal__btn-secondary flex-fill`} onCLick={cancelModal}>
					{text_cancel}
				</button>
				<button className={`modal__button ${style}__modal__btn-primary flex-fill`} onCLick={confirmModal}>
					{text_confirm}
				</button>
			</Modal.Footer>
		</Modal>
