...
const admNavbarData = {
  brand: {
    title: "GreenGo",
    imgageSrc: "./src/assets/img/admBrand.svg",
  },
  navLink: {
    title: "訂單管理",
    route: "order",
      ...
      <nav className="navbar fixed-top">
        <div className="container adm__navbar adm__glassbg ">
          ...
          <span className="navbar-brand ft-en fw-semibold">
            <img
              src={admNavbarData.brand.imgageSrc}
              alt={admNavbarData.brand.title}
              className="me-2"
            />
          ...
          <ul className="navbar-nav delete__navbar_nav__glassbg">
            <li className="nav-item">
              <NavLink
                className="nav-link adm__navLink"
                to={admNavbarData.navLink.route}
              >
