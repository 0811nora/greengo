                    ...
                    <div className='col-6'>
                      <ul className='list-unstyled'>
                        {FooterData.explore.links
                          .slice(4)
                          .map((link, index) => (
                            <li className='fs-6 fw-medium mb-4' key={index}>
                              <NavLink className='nav-link' to={link.url}>
                                <div className='text-primary-100 text-decoration-none'>
                                  {link.title}
                                </div>
                              </NavLink>
                            </li>
                  ...
                  <div>
                    <ul className='list-unstyled d-md-none'>
                      {FooterData.explore.links.map((link, index) => (
                        <li key={index} className='lh-sm fw-medium mb-4'>
                          <NavLink
                            to={link.url}
                            className='text-primary-100 text-decoration-none'
                          >
                            {link.title}
                          </NavLink>
                        </li>
