...
export default function Product() {
  ...
  const fixedProducts = productsData?.filter(
      ...
      <header>
        <div className="container d-flex flex-column justify-content-between align-items-center">
          <div className="d-flex flex-column align-items-center">
            <h1 className="text-primary-300 fw-semibold mb-5">
              Green Go 精選菜單
            </h1>
            <div className="d-flex flex-column flex-md-row">
              <h5 className="fw-normal text-brown-300 text-center m-1">
                當季最新鮮、營養最到位，
              </h5>
              <h5 className="fw-normal text-brown-300 text-center m-1">
                每一口都是 GreenGo 的健康提案
      ...
      <section className="container set-section ">
        ...
        <div className="meal-filter d-flex justify-content-between gap-6 mt-10">
          ...
          <Select
            ...
            classNames={{
              control: ({ isFocused }) =>
                classNames("rs__control", isFocused && "rs__focus"),
              menu: () => classNames("rs__menu"),
              option: ({ isFocused }) =>
                classNames("rs__option", isFocused && "rs__focus"),
            }}
          />
          <Select
            options={sortOptions}
              ...
              <div className="card">
                ...
                <div className="card-body d-flex flex-column gap-5 px-6 py-7">
                  <div className="d-flex gap-1">
                    <h6 className="fw-semibold mb-2 text-gray-600">
                      {product.title}
                    </h6>
                    <div className="d-flex gap-1">
                      <div className="tag">
                  ...
                  <div className="card-footer">
                    ...
                    <div className="button-section d-flex align-items-center gap-3">
                      ...
                      <button className="addCart primary-btn">
                        加入購物車
                      </button>
                    </div>
                  </div>
