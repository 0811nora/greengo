...
export default function AdminBlog() {
  ...
  // 篩選內容
  const filterValue = () => {
    if (!articleList || articleList.length === 0 || filterTargetType === "全部")
      return [];
  ...
  const sendEditedArticle = async () => {
    ...
    try {
      ...
      notify('error', `送出失敗:${error.response.data.message}`,"bottom-center");
    }
  };
  ...
  const deleteArticle = async () => {
    ...
    try {
      ...
      notify('error', `刪除失敗:${error.response.data.message}`,"bottom-center");
    }
  };
      ...
      <main className="adm-blog">
        <div className="container py-3">
          ...
          <div>
            <div className="row g-4 align-items-center mb-6">
              ...
              <div className="col-md text-end pe-4 ">
                <button
                  type="button"
                  className="btn btn adm__button__primary py-3 fw-blod px-6 text-white"
                  style={{ borderRadius: "28px" }}
                  onClick={openCreateModal}
                >
                  <i className="bi bi-plus-lg me-1"></i>新增文章
                </button>
              </div>
            </div>
          </div>
          ...
          >
                  ...
                  {selectArticle?.map((item) => (
                    <tr key={item.id}>
                      ...
                      <td className="">
                        {item?.tag?.map((i) => (
                          <span
                            className="p-1 m-1 text-nowrap lh bg-orange-100 rounded py-2 px-4"
                            key={i}
                          >
                            {i}
                          </span>
            ...
            <div
              className="modal modal-blog fade"
              ref={detailModalRef}
              tabIndex="-1"
            >
              <div
                ...
                <div className="modal-content border-0 shadow-lg">
                  ...
                  >
                    <img
                      src={
                        singleDetail.image ||
                        "https://placehold.co/800x200/eeeeee/999999?text=No+Image"
                      }
                  ...
                  <div className="modal-body p-0">
                    <div className="bg-light border-bottom px-4 py-3 d-flex justify-content-between align-items-center">
                      ...
                      <div className="d-flex align-items-center">
                        {isEdit ? (
                          ...
                          <span className="badge rounded-pill text-white bg-brown-200">
                            草稿
                          </span>
                        )}
                      </div>
                      ...
                      <div className="d-flex align-items-center gap-3 text-muted small">
                        {isEdit ? (
                          <>
                            <div className="d-flex align-items-center">
                              <label className="text-muted small me-2 mb-0 text-nowrap">
                                作者:
                              </label>
                              <input
                                type="text"
                        ...
                        <span>
                          ...
                          {timeChange(singleDetail.create_at)}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="px-5 py-3">
                      ...
                      <div className="d-flex align-items-center mb-3">
                        <span className="text-muted small me-3 text-nowrap">
                          分類標籤:
                        </span>
                        <div className="d-flex flex-wrap gap-2">
                          {isEdit
                            ? availableTags.map((tag) => (
                                ...
                                >
                                  <input
                                    ...
                                    id={`tag-${tag}`}
                                    checked={
                                      singleDetail.tag?.includes(tag) || false
                                    }
                                    value={tag}
                                    name="tag"
                                    onChange={handleEditChange}
                            ...
                            : singleDetail?.tag?.map((i) => (
                                <span
                                  key={i}
                                  className="badge border bg-brown-300 fw-normal rounded-pill px-3"
                                >
                                  #{i}
                                </span>
                              ))}
                      ...
                      <div className="mb-3">
                        {isEdit ? (
                          ...
                          <h3 className="fw-bold m-0 bg-success-subtle">
                            {singleDetail.title}
                          </h3>
                        )}
                      </div>
                    ...
                    {isEdit ? (
                      <div className="ms-auto">
                        ...
                        {mode === "create" ? (
                          <button
                            ...
                            onClick={() => {
                              (setIsOpenModal(true), setModalText("新增"));
                      ...
                      <>
                        ...
                        <div>
                          <button
                            type="button"
                            className="btn btn-sm btn-light border px-3 me-2"
                            data-bs-dismiss="modal"
                          >
                            關閉
                          </button>
